...
import '/features/assistant/view/assistant_page.dart';
import '/features/auth/provider/login_provider.dart';
import '/features/cart/views/cart_page.dart';
import '/features/community/views/edit_post.dart';
import '/features/community/views/new_post.dart';
import '/features/dashboard/views/dashboard.dart';
import '/features/dashboard/views/main_container.dart';
import '/features/dashboard/views/orders_page.dart';
import '/features/dashboard/views/products/edit_product.dart';
import '/features/dashboard/views/products/new_products.dart';
import '/features/dashboard/views/products/product_main.dart';
import '/features/dashboard/views/products/products_page.dart';
import '/features/dashboard/views/profile_page.dart';
import '/features/main/views/home_page.dart';
import '/features/main/views/main_page.dart';
import '/features/market/vews/market_page.dart';
